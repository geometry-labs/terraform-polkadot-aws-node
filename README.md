...
| polkadot\_client\_hash | SHA256 hash of Polkadot client binary | `string` | `"cc3bb44e3edc482111fc04b1426b7e2428e8c4b65cf1423c9d892ba97b6f7915"` | no |
| polkadot\_client\_url | URL to Polkadot client binary | `string` | `"https://github.com/paritytech/polkadot/releases/download/v0.9.16/polkadot"` | no |
